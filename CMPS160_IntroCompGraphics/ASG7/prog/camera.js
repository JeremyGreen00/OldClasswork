...
class Camera {
    ...
    */
    constructor() {
      ...
      //controller varialbes
      this.keyW = false
      this.keyS = false
      this.keyA = false
      this.keyD = false

      this.projectionMatrix.setPerspective(60, 
    ...
    */
    rotate(angle, x, y, z) {
      ...
      if(this.angley > Math.PI-0.1) this.angley = Math.PI-0.1
      if(this.angley < 0.1) this.angley = 0.1
