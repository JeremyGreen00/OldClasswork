...
public:
    ...
    void randomFill(int);                                           // fills the board randomly
    bool checkWinner(char c);                                       // checks to see if c has won
    void setTo(HexBoard);                                           // sets all values to input
...
private:
    ...
    vector<pair<int, int>> remainingMoves;                          // Stores remaining moves
    int size;
